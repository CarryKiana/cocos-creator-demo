...
import { _decorator, Component, Node, Prefab, instantiate, Vec3, NodePool, LabelComponent, math, find, AnimationComponent, Game } from 'cc';
 ...
 * Name = GameManager
 * DateTime = Mon Nov 15 2021 15:55:19 GMT+0800 (中国标准时间)
 * Author = carryKiana
 * FileBasename = GameManager.ts
 * FileBasenameNoExtension = GameManager
 * URL = db://assets/simple-run/scripts/GameManager.ts
...
export class GameManager extends Component {
    ...
    reset () {
        ...
        // init
        for (let i = 0; i < GameDefines.maxAcativeFloor; i++) {
